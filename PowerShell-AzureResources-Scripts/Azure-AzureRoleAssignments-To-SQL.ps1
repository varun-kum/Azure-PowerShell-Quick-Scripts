...
$sqlcc = new-object ('System.Data.SqlClient.SqlConnection') "Data Source='AzureDB.database.windows.net';Initial Catalog=AzureDB;Persist Security Info=True;User ID='<user>';Password='<password>'"
...
# Delete the existing data from table
 Invoke-Sqlcmd -Query "Delete from AzureRoleAssignments" -ConnectionString "Data Source='AzureDB.database.windows.net';Initial Catalog=AzureDB;Persist Security Info=True;User ID='<user>';Password='<Password>'"
